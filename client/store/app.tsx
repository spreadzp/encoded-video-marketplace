...
interface AppState {
  ...
  addressRecipient: string | undefined
  setAddressRecipient: (address: string | undefined) => void
...
export const useAppStore = create<AppState>((set) => ({
  ...
  addressRecipient: undefined,
  setAddressRecipient: (address: string | undefined) => set(() => ({ address })),
  client: undefined,
